...
<body>
    ...
    <div class="container-fluid bg-white pt-3 px-lg-5">
        <div class="row mx-n2">
            ...
            <div class="col-xl-2 col-lg-4 col-md-6 px-2">
                <select class="custom-select px-4 mb-3" style="height: 50px;" style ="whe*">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">loca  Car</h4>
                            <h1 class="display-1 text-white mb-md-4">Best loca Cars In Your Location</h1>
                            <a href="car.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Reserve Now</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Welcome To <span class="text-primary">LOCA CAR </span></h1>
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <img class="w-75 mb-4" src="img/about.png" alt="">
                     <p> <h4>La société Original loca car vous offre des voitures neuves, propres et bien maintenues, vidange gratuit, nous mettons à votre disposition une gamme de voitures neuves et diversifiées ainsi que des voitures de haute gamme : Mercedes, BMW , Jaguar,AUDI des voitures Compactes , lux, Berline et économique pour des prix raisonnables.</h4></p>
                </div>
            </div>
            <div class="row mt-3">
      ...
      <?php foreach($Produits as $produit): ?> 
        <div class="col">
          <div class="card shadow-sm">
            <h3><?= $produit->nom ?></h3>
            <img src="<?= $produit->image ?>" style="width: 90%">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  ...
                  <a href="../car-rental-html-template/car.php"<?= $produit->id ?>><button type="button" class="btn btn-sm btn-success ">voir plus </button></a>
                </div>
            ...
            ?>
                 <small class="text" style="font-weight: bold; color: red;"><?=   $res["classe"]; ?></small>

...
<script src="https://developer.snapappointments.com/bootstrap-select/ajax/libs/highlight.js/9.15.6/js/highlight.pack.js.pagespeed.jm.dO4qkBpHzz.js"></script>
    ...
    <script src="<?php echo URLROOT; ?>/public/lib/tempusdominus/js/moment.min.js"></script>
    <script src="<?php echo URLROOT; ?>/public/lib/tempusdominus/js/moment-timezone.min.js"></script>
    <script src="<?php echo URLROOT; ?>/public/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>

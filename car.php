            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  ...
                  <a href="../view/front/livraison.php"<?= $produit->id ?>><button type="button" class="btn btn-sm btn-success ">commander  </button></a>
                  <a href="../../rento/index_rec.php"<?= $produit->id ?>><button type="button" class="btn btn-sm btn-success ">louer  </button></a>
